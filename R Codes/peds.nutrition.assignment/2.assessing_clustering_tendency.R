...
# 4.1  NbClust (majority vote across up to 30 indices) --------------------
...
# NbClust (majority vote across up to 30 indices) --------------------
cat("\nRunning NbClust on zBMI Growth Clusters...\n")
set.seed(42)
...
print(plot1) #Show the plot as a result of Nb Clustering Voting = 3
#===========================================================================
# PLOT 2: ELBOW METHOD
# ============================================================================
